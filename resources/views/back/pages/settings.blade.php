...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Configuración')
@section('content')
   ...
   <div class="card">
    <ul class="nav nav-tabs" data-bs-toggle="tabs">
      <li class="nav-item">
        <a href="#tabs-home-17" class="nav-link active" data-bs-toggle="tab">General</a>
      </li>
      <li class="nav-item">
        <a href="#tabs-profile-17" class="nav-link" data-bs-toggle="tab">Logo e ícono</a>
      </li>
      <li class="nav-item">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="tabs-profile-17">
          <div>
            <div class="row">
              <div class="col-md-6">
                <h3>Seleccionar logo de Blog</h3>
              ...
              <div class="col-md-6">
                <h3>Seleccionar ícono de Blog</h3>
