...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Buscar')
@section('content')
            ...
            <div class="col-md-6 mb-4">
                <article class="card article-card article-card-sm h-100">
                    ...
                    <div class="card-body px-0 pb-0">
                        ...
                        <div class="content"> <a class="read-more-btn" href="{{ route('read_post',$item->post_slug) }}">Leer</a>
                        </div>
                    </div>
                </article>
            </div>
            @empty
                <span class="text-danger">Artículos no disponibles</span>
            @endforelse
        </div>
        <div class="col-12">
            <div class="row">
                    ...
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <p class="mb-3 pb-2">Hello, I’m Hootan Safiyari. A Content writter, Developer and Story
                                ...
                                href="about.html" class="btn btn-sm btn-outline-primary">Saber Más</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-6">
                    <div class="widget">
                        <h2 class="section-title mb-3">Últimos Publicados</h2>
                        <div class="widget-body">
