...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Categorías')
@section('content')
            ...
            <div class="col-md-6 mb-4">
                <article class="card article-card article-card-sm h-100">
                    ...
                    <div class="card-body px-0 pb-0">
                        ...
                        <div class="content"> <a class="read-more-btn" href="{{ route('read_post',$item->post_slug) }}">Leer artículo completo</a>
                        </div>
                    </div>
                </article>
            </div>
            @empty
                <span class="text-danger">No se encontraron artículos para esta categoría</span>
            @endforelse
        </div>
        <div class="col-12">
            <div class="row">
